...
struct MealDetail: Identifiable, Codable {
    ...
    //decoding each ingredient and measurement based on API response
    ...
    var ingredients: [String] {
        ...
        for (ingredient, measure) in zip(ingredientList, measureList) { //return pairs from ingredient and measure
            if let ingredient = ingredient?.trimmingCharacters(in: .whitespacesAndNewlines), !ingredient.isEmpty {
                ...
                if !measurement.isEmpty { //highly unlikely but just incase
